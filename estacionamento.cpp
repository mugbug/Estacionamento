...
void cadastro()
{
  ...
  do{
    ...
    limpar();			//limpeza do espa�o que sobra na variavel
    cout<<endl;
    cout<<"##################################################################"<<endl;
    cout<<"#                                                                #"<<endl;
    ...
    do{
      ...
      cin.ignore();
      if (o!= 's' && o!='S' && o!='n' && o!='N')
      cout<<"    \t>> n�o seja est�pido"<<endl;			//ARRUMAR!!!!!!!!!!
    ...
    do{
      ...
      while(!feof(teste)){
        if( strcmp(c1.placa, edicao) == 0 && c1.existe == 1){
          ...
          if(i!=0){
            cout<<endl<<"    \t>> Esse � o cliente a ser editado? (s ou n)";
            do{
              cout<<endl;
              cout<<"    \t>> ";
              cin>>o;
          ...
          if (o=='s' || o=='S'){
            do{
              ...
              cout<<"##################################################################"<<endl;
              cout<<"#                                                                #"<<endl;
              cout<<"#   \t\tEdi��o realizada com sucesso!                    #"<<endl;
              cout<<"#                                                                #"<<endl;
              cout<<"##################################################################"<<endl;
          ...
          cout<<endl;
          cout<<"    \t>> Deseja procurar outro cliente para edi��o? (s ou n)";
      ...
      if (i==0){
        cout<<"    \t>> Carro n�o encontrado"<<endl<<endl;
        cout<<"    \t>> Deseja procurar outro cliente para edi��o? (s ou n)";
        do{
          cout<<endl;
          cout<<"    \t>> ";
    ...
    do{
      ...
      while(!feof(teste)){
        if( strcmp(c1.placa, exclusao) == 0 && c1.existe == 1){
          ...
          if(i!=0){
            cout<<"    \t>> Esse � o cadastro a ser exclu�do? (s ou n)";
            do{
              cout<<endl;
              cout<<"    \t>> ";
              cin>>o;
...
void listar()
{
  ...
  cout<<endl<<"    \t>> Pressione enter para continuar...";
    ...
    cout<<endl<<"    \t>> N�o h� nenhum cliente cadastrado.";
    cout<<endl<<"    \t>> Pressione enter para continuar...";
  }
  cin.ignore();
}
...
int main()
{
  ...
  do{
    ...
    cout<<"  ______________________________________________________________"<<endl;
    cout<<"/|   \t                                                        |\n";
    cout<<" |   \tN�mero da Op��o Desejada: ";
    //entrada da op�ao escolhida
